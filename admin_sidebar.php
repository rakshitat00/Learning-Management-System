<div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li>
                            <a href="class.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Batch</a>
                        </li>
						<li  class="active">
                            <a href="admin_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i> Admin Users</a>
                        </li>
						<li>
                            <a href="department.php"><i class="icon-chevron-right"></i><i class="icon-building"></i> Stream</a>
                        </li>
						<li>
